...
//     super.initState();
//     recipeFuture= context.read<RecipeProvider>().getRecipeDetail(widget.recipeId);
//   }
//   @override
...
//         //bool isWishListed= wishlistProvider.isFavourite(recipe.id);
...
//                                 //   image: ,
//                                 //    name: result['name'],
//                                 //     cuisine: , rating: rating, servings: servings, prepTimeMinutes: prepTimeMinutes, cookTimeMinutes: cookTimeMinutes, difficulty: difficulty, ingredients: ingredients, instructions: instructions, caloriesPerServing: caloriesPerServing, tags: tags, mealType: mealType)
//                               });
...
//                       children: [
//                         Flexible(
//                           child: _infoBox(Icons.access_time, "Cooking time", "${recipe.cookTimeMinutes} mins",
//                           ),
//                         ),
...
class _RecipeDetailPageState extends State<RecipeDetailPage> {
  ...
  void initState() {
    super.initState();
    recipeFuture =
        context.read<RecipeProvider>().getRecipeDetail(widget.recipeId);
  }
